...
export class Project__exPostVintageMappingResult {
  value0: string;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Project__retirementMappingResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: string;
...
export class Project__getExPostVintageDataResultValue0Struct extends ethereum.Tuple {
  get serialization(): string {
...
export class Project__transferAndRetireFromSignatureInputPayloadStruct extends ethereum.Tuple {
  get deadline(): BigInt {
    return this[0].toBigInt();
  }
...
export class Project__retireFromSignatureInputPayloadStruct extends ethereum.Tuple {
  get deadline(): BigInt {
    return this[0].toBigInt();
  }
...
export class Project extends ethereum.SmartContract {
  ...
  exPostVintageMapping(param0: BigInt): Project__exPostVintageMappingResult {
    let result = super.call(
    ...
    return new Project__exPostVintageMappingResult(
      result[0].toString(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_exPostVintageMapping(
    param0: BigInt
  ): ethereum.CallResult<Project__exPostVintageMappingResult> {
    let result = super.tryCall(
      "exPostVintageMapping",
      "exPostVintageMapping(uint256):(string,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new Project__exPostVintageMappingResult(
        value[0].toString(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  retirementMapping(param0: BigInt): Project__retirementMappingResult {
    let result = super.call(
      "retirementMapping",
    ...
    return new Project__retirementMappingResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toString(),
  ...
  try_retirementMapping(
    param0: BigInt
  ): ethereum.CallResult<Project__retirementMappingResult> {
    let result = super.tryCall(
      "retirementMapping",
      "retirementMapping(uint256):(address,uint256,uint256,string,string,string)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Project__retirementMappingResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toString(),
  ...
  getExPostVintageData(
    exAnteTokenId: BigInt
  ): Project__getExPostVintageDataResultValue0Struct {
    let result = super.call(
      "getExPostVintageData",
      "getExPostVintageData(uint256):((string,uint256,uint256,uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(exAnteTokenId)]
    );

    return changetype<Project__getExPostVintageDataResultValue0Struct>(
      result[0].toTuple()
    );
  }

  try_getExPostVintageData(
    exAnteTokenId: BigInt
  ): ethereum.CallResult<Project__getExPostVintageDataResultValue0Struct> {
    let result = super.tryCall(
      "getExPostVintageData",
      "getExPostVintageData(uint256):((string,uint256,uint256,uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(exAnteTokenId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Project__getExPostVintageDataResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }

  transferAndRetireFromSignature(
    signature: Bytes,
    payload: Project__transferAndRetireFromSignatureInputPayloadStruct,
    retireeName: string,
    customUri: string,
    comment: string,
    data: Bytes
    ...
    let result = super.call(
      "transferAndRetireFromSignature",
      "transferAndRetireFromSignature(bytes,(uint256,string,address,address,uint256,uint256,uint256),string,string,string,bytes):(uint256)",
      [
  ...
  try_transferAndRetireFromSignature(
    signature: Bytes,
    payload: Project__transferAndRetireFromSignatureInputPayloadStruct,
    retireeName: string,
    customUri: string,
  ...
  retire(
    ...
    let result = super.call(
      "retire",
      "retire(uint256,uint256,string,string,string,bytes):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(tokenId),
  ...
  retireFromSignature(
    signature: Bytes,
    payload: Project__retireFromSignatureInputPayloadStruct,
    retireeName: string,
    customUri: string,
    comment: string,
    data: Bytes
...
export class CreateExPostVintageBatchCall__Inputs {
  ...
  get vintages(): Array<CreateExPostVintageBatchCallVintagesStruct> {
    return this._call.inputValues[0].value.toTupleArray<
      CreateExPostVintageBatchCallVintagesStruct
    >();
  }
}
...
export class AdminBurnCall extends ethereum.Call {
  get inputs(): AdminBurnCall__Inputs {
    return new AdminBurnCall__Inputs(this);
  }

  get outputs(): AdminBurnCall__Outputs {
    return new AdminBurnCall__Outputs(this);
  }
}

export class AdminBurnCall__Inputs {
  _call: AdminBurnCall;

  constructor(call: AdminBurnCall) {
    this._call = call;
  }
...
export class AdminBurnCall__Outputs {
  _call: AdminBurnCall;
...
export class TransferAndRetireFromSignatureCall extends ethereum.Call {
  get inputs(): TransferAndRetireFromSignatureCall__Inputs {
    return new TransferAndRetireFromSignatureCall__Inputs(this);
  }

  get outputs(): TransferAndRetireFromSignatureCall__Outputs {
    return new TransferAndRetireFromSignatureCall__Outputs(this);
  }
}

export class TransferAndRetireFromSignatureCall__Inputs {
  _call: TransferAndRetireFromSignatureCall;

  constructor(call: TransferAndRetireFromSignatureCall) {
    this._call = call;
  }
  ...
  get payload(): TransferAndRetireFromSignatureCallPayloadStruct {
    return changetype<TransferAndRetireFromSignatureCallPayloadStruct>(
...
export class TransferAndRetireFromSignatureCall__Outputs {
  _call: TransferAndRetireFromSignatureCall;
...
export class TransferAndRetireFromSignatureCallPayloadStruct extends ethereum.Tuple {
  get deadline(): BigInt {
    return this[0].toBigInt();
  }
